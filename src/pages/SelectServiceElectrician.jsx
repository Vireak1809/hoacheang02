...
const SelectServiceElectrician = () => {
  ...
  const problems = [
    { id: 'power_off', icon: 'power_off', label: 'ភ្លើងដាច់' },
    { id: 'breaker', icon: 'electrical_services', label: 'Breaker លោត' },
    { id: 'outlet', icon: 'power', label: 'ព្រីភ្លើងខូច' },
    { id: 'switch', icon: 'toggle_on', label: 'កុងតាក់ខូច' },
    { id: 'wiring', icon: 'cable', label: 'ខ្សែភ្លើងមានបញ្ហា' },
  ...
  return (
    <div className="container-custom py-6 md:py-10 animate-enter">
      ...
      <div className="flex items-center justify-start md:justify-center overflow-x-auto pb-4 gap-3 custom-scrollbar mb-8">
        ...
        <Link to="/select/electrician" className="flex items-center gap-2 whitespace-nowrap bg-primary text-white px-6 py-3 rounded-xl shadow-md transition">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-8">
          <h2 className="text-2xl font-bold text-on-surface mb-4">បញ្ហាអគ្គិសនីដែលអ្នកជួបប្រទះ</h2>
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              placeholder="សូមពិពណ៌នាបញ្ហាភ្លើងដែលអ្នកកំពុងជួបប្រទះ..."
            ></textarea>
          </div>
        </div>
          ...
          <div className="bg-surface-container rounded-2xl p-6 shadow-sm border border-outline-variant sticky top-24">
            ...
            <div className="space-y-2 mb-6">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold">ជាងភ្លើង</span>
              </div>
              <div className="flex justify-between text-sm">
